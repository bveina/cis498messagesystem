...
namespace Console_Server
{
    ...
    class TFMS_Server_Main
    {
        ...
        #region TFMS_Server_Main commands
        ...
        static void handleLoginRequest(TFMS_Data data)
        {
        ...
        static void handleLogoffRequest(TFMS_Data data)
        {
        ...
        static void handleListRequest(TFMS_Data data)
        {
        ...
        static void handleRelayRequest(TFMS_Data data)
        {
        ...
        #region TFMS_Server_Main database logging
        ...
        static void logMessage(TFMS_Data data)
        {
